...
5. Enter the current authenticator code from the separately enrolled authenticator. The existing `/admin/session/elevate` endpoint validates it; incorrect, reused or rate-limited codes fail.
